...
//smooth scroll function for mobile view
  ...
  return (
    ...
    >
     ...
     {/*logo*/}
        ...
        <span className ='text-white'>Anushka Bhuskat</span>
        <span className ='text-[#8245ec]'>&gt;</span>
        </div>
        {/*Desktop Menu*/}
...
<li key={item.id} className={'cursor-pointer hover:text-[#8245ec] ${activeSection == item.id ? "text-[#8245ec]":""'}>
  <button onClick = {() => handleMenuItemClick(item, item.id)}>
    {item.label}
  </button>
</li>
        ...
        <div  className="hidden md:flex space-x-4">
          <a 
          href="https://github.com/AnushkaBhuskat"
          target="blank"
          ...
          <FaGithub size={24}/>
           ...
           <a 
          href="https://www.linkedin.com/in/anushka-bhuskat-a253222a1"
          target="blank"
          rel="noopener noreferrer"
          className='text-grey-300 hover:text-[#8245ec]'
          >
